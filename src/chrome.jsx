...
export function SiteFooter() {
  return (
    <footer style={s("background: #060708; padding: 26px 32px;")}>
      <div style={s("max-width: 1200px; margin: 0 auto; display: flex; justify-content: space-between; align-items: center; gap: 16px; flex-wrap: wrap;")}>
        <a className="brand-logo brand-logo-sm" href="/" aria-label="aisolhub">
          <BrandMark size={28} />
          <span className="brand-word">aisolhub</span>
        </a>
        <div style={s("font-family: 'IBM Plex Mono', monospace; font-size: 12.5px; color: #6f757e;")}>© 2026 aisolhub. All rights reserved.</div>
        <div style={s("display: flex; align-items: center; gap: 10px; flex-wrap: wrap;")}>
          ...
          <a className="footer-wa hvr-7" href={waLink} target="_blank" rel="noopener noreferrer" style={s("font-family: 'IBM Plex Mono', monospace; font-size: 13px; color: #7ea7d8;")}>WhatsApp →</a>
        </div>
      </div>
    </footer>
  );
